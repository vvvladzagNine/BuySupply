...
public class OfferServiceTest {
    ...
    public void create() throws Exception {
        ...
        Offer created = offerService.create(newOffer, USER1_ID,newOffer.getCategory().getId());
    ...
    public void update() throws Exception {
        ...
        offerService.update(updated, updated.getOfferer().getId(),updated.getCategory().getId());
    ...
    public void updateNotOwn() throws Exception {
        Offer updated = new Offer(OFFER2);
        updated.setAmount(10000000);
        offerService.update(updated, USER2_ID,updated.getCategory().getId());
    }
